...
ComponentType = Union[
    Input, Select, DatePicker, MultiSelect, Button, 
    MapPin, RangeSlider, VisualPicker, Stepper, Switch
]

class UIResponse(BaseModel):
    components: List[ComponentType] = Field(default_factory=list, description="List of UI components to render")
    message: Optional[str] = Field(None, description="Direct answer or explanation if no UI is needed")
